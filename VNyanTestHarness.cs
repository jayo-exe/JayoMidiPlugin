...
namespace JayoMidiPlugin
{
    internal class VNyanTestHarness : MonoBehaviour
    {
        ...
        public void refreshButtonDisplay()
        {
            ...
            buttonHolderObject.GetComponent<RectTransform>().SetInsetAndSizeFromParentEdge(RectTransform.Edge.Top, gap, (gap + ((gap + buttonHeight) * registeredPlugins.Keys.Count)));
